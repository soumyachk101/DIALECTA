"""
Persona system prompts — copy of AI_INSTRUCTIONS.md §3, kept as code
so changes to the spec are tracked in source control.
"""
...
- Respond ONLY with valid JSON matching the schema: {"message": str, "citations": [{"source": str, "detail": str}], "confidence": float, "no_context_found": bool}
"""
...
Respond ONLY with valid JSON matching: {"message": str, "citations": [], "confidence": 0.9, "no_context_found": false}
"""
